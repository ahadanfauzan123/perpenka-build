...
import Thumbs2 from "../public/img/logoBaru.jpg"
  ...
  return (
    ...
    className='bg-white rounded-2xl shadow-lg shadow-gray-300 text-gray-600 w-[85%] lg:w-[30%] h-[500px] flex flex-col space-y-3'>
      <div className='bg-gray-400 rounded-t-2xl w-full h-[60%]'>
        {thumbs == "hut" ? (
          <Image alt="hut" src={Thumbs1} width={200} height={200} className='w-full h-full rounded-t-xl' />
          ): (
                <Image alt="hut" src={Thumbs2} width={200} height={200} className='w-full h-full rounded-t-xl' />
            )}
      </div>
