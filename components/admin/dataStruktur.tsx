...
interface DataStrukturProps {
      currentItems: StrukturItem[];
      onDelete: (id: string) => void;
}

function DataStruktur({ currentItems, onDelete }: DataStrukturProps) {
...
function StrukturPaginatedItems({ itemsPerPage }: PaginatedItemsProps) {
      const [itemOffset, setItemOffset] = useState(0);
      const [fullGallery, setFullGallery] = useState<StrukturItem[]>([]);
  ...
  return (
    <>
      ...
      <DataStruktur currentItems={currentItems} onDelete={handleDeleteItem} />
    </>
  );
}

export default StrukturPaginatedItems;