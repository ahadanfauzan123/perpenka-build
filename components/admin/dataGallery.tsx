...
function DataGallery({ currentItems, onDelete }: DataGalleryProps) {
...
function GalleryPaginatedItems({ itemsPerPage }: PaginatedItemsProps) {
      const [itemOffset, setItemOffset] = useState(0);
      const [fullGallery, setFullGallery] = useState<GalleryItem[]>([]);
  ...
  return (
    <>
      ...
      <DataGallery currentItems={currentItems} onDelete={handleDeleteItem} />
    </>
  );
}

export default GalleryPaginatedItems;