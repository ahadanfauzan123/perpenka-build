...
function AddPhotoBanner() {
  ...
  return (
      ...
      <div className='w-full min-h-screen flex items-center justify-start flex-col space-y-3 my-[100px]'>       
                              ...
                              <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-[300px] bg-white border-4 border-gray-300 border-dashed rounded-lg cursor-pointer">
                                    <div
