  ...
  return (
      ...
      <div className='w-full h-screen flex items-center justify-start flex-col space-y-3 mt-[100px]'>       
            <div
                  ...
                  onDrop={handleDrop}  className="flex items-center justify-center w-[60%]">
                  <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-[280px] bg-white border-4 border-gray-300 border-dashed rounded-lg cursor-pointer">
                        <div
