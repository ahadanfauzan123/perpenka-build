  ...
  return (
    ...
    className="bg-gray-100 w-screen min-h-screen overflow-x-hidden">
      ...
      <div className="relative w-full bg-[1c2d8c] bg-gradient-to-tr from-[#ff7f00] to-[#e9841e] py-10 my-10">
        {/* svg 1 */}        
        <svg className=" absolute right-5 top-7" width="67" height="77" viewBox="0 0 67 77" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<svg className="absolute bottom-6 right-[55px] scale-150" width="90" height="90" viewBox="0 0 90 90" fill="none" xmlns="http://www.w3.org/2000/svg">
